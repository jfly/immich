...
class SyncEntityType {
  ...
  static const faceV1 = SyncEntityType._(r'FaceV1');
  static const faceDeleteV1 = SyncEntityType._(r'FaceDeleteV1');
  ...
  SyncEntityType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'FaceV1': return SyncEntityType.faceV1;
        case r'FaceDeleteV1': return SyncEntityType.faceDeleteV1;
