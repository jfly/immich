...
final class $$PersonEntityTableReferences extends i0.BaseReferences<
  ...
  static i6.$AssetFaceEntityTable _faceAssetIdTable(i0.GeneratedDatabase db) =>
      i5.ReadDatabaseContainer(db)
          .resultSet<i6.$AssetFaceEntityTable>('asset_face_entity')
          .createAlias(i0.$_aliasNameGenerator(
              i5.ReadDatabaseContainer(db)
                  .resultSet<i1.$PersonEntityTable>('person_entity')
                  .faceAssetId,
  ...
  i6.$$AssetFaceEntityTableProcessedTableManager? get faceAssetId {
    final $_column = $_itemColumn<String>('face_asset_id');
    ...
    final manager = i6
        .$$AssetFaceEntityTableTableManager(
            ...
            i5.ReadDatabaseContainer($_db)
                .resultSet<i6.$AssetFaceEntityTable>('asset_face_entity'))
        .filter((f) => f.id.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_faceAssetIdTable($_db));
    if (item == null) return manager;
    return i0.ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: [item]));
  }
...
class $$PersonEntityTableFilterComposer
  ...
  i6.$$AssetFaceEntityTableFilterComposer get faceAssetId {
    final i6.$$AssetFaceEntityTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.faceAssetId,
        referencedTable: i5.ReadDatabaseContainer($db)
            .resultSet<i6.$AssetFaceEntityTable>('asset_face_entity'),
        getReferencedColumn: (t) => t.id,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
            i6.$$AssetFaceEntityTableFilterComposer(
              $db: $db,
              $table: i5.ReadDatabaseContainer($db)
                  .resultSet<i6.$AssetFaceEntityTable>('asset_face_entity'),
              $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
...
class $$PersonEntityTableOrderingComposer
  ...
  i6.$$AssetFaceEntityTableOrderingComposer get faceAssetId {
    final i6.$$AssetFaceEntityTableOrderingComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.faceAssetId,
        referencedTable: i5.ReadDatabaseContainer($db)
            .resultSet<i6.$AssetFaceEntityTable>('asset_face_entity'),
        ...
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
            i6.$$AssetFaceEntityTableOrderingComposer(
              $db: $db,
              $table: i5.ReadDatabaseContainer($db)
                  .resultSet<i6.$AssetFaceEntityTable>('asset_face_entity'),
              $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
...
class $$PersonEntityTableAnnotationComposer
  ...
  i6.$$AssetFaceEntityTableAnnotationComposer get faceAssetId {
    final i6.$$AssetFaceEntityTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.faceAssetId,
            referencedTable: i5.ReadDatabaseContainer($db)
            ...
            builder: (joinBuilder,
                    {$addJoinBuilderToRootComposer,
                    $removeJoinBuilderFromRootComposer}) =>
                i6.$$AssetFaceEntityTableAnnotationComposer(
                  $db: $db,
                  $table: i5.ReadDatabaseContainer($db)
                      .resultSet<i6.$AssetFaceEntityTable>('asset_face_entity'),
                  $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
...
class $$PersonEntityTableTableManager extends i0.RootTableManager<
    ...
    i1.PersonEntityData,
    i0.PrefetchHooks Function({bool ownerId, bool faceAssetId})> {
  $$PersonEntityTableTableManager(
      ...
      : super(i0.TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({ownerId = false, faceAssetId = false}) {
            return i0.PrefetchHooks(
              ...
              addJoins: <
                ...
                if (faceAssetId) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.faceAssetId,
                    referencedTable:
                        i1.$$PersonEntityTableReferences._faceAssetIdTable(db),
                    referencedColumn: i1.$$PersonEntityTableReferences
                        ._faceAssetIdTable(db)
                        .id,
                  ) as T;
                }
...
class $PersonEntityTable extends i2.PersonEntity
  ...
  late final i0.GeneratedColumn<String> thumbnailPath =
      i0.GeneratedColumn<String>('thumbnail_path', aliasedName, true,
  ...
  late final i0.GeneratedColumn<String> faceAssetId =
      i0.GeneratedColumn<String>('face_asset_id', aliasedName, true,
          ...
          requiredDuringInsert: false,
          defaultConstraints: i0.GeneratedColumn.constraintIsAlways(
              'REFERENCES asset_face_entity (id) ON DELETE SET NULL'));
...
class PersonEntityData extends i0.DataClass
  ...
  int get hashCode => Object.hash(id, createdAt, updatedAt, ownerId, name,
      thumbnailPath, isHidden, birthDate, faceAssetId, isFavorite, color);
  @override
